var currentTasks = document.getElementById('current-job');
...
function current () {
    if (inputTasks.value == "") {
        ...
        deleteList.style.backgroundColor = '#144164';
...
function checkedTask () {
    ...
    if (nodeList.classList.contains('completed')) {
        ...
        nodeList.querySelector('div').style.backgroundColor = 'rgb(199, 148, 21)';
